...
#define TIME_INIT0 16.0d0
!                       Initial time of simulation (in a)

#define TIME_END0 310.0d0
...
#define ANFDATNAME 'repo_grl20_b2_paleo210005.nc'
...
#define GRIP_TEMP_FILE 'grl_rcp85.dat'
...
#define TIME_OUT0 [ 0.0d0, 16.0d0, 66.0d0, 116.0d0, 166.0d0, 216.0d0, 266.0d0, 310.0d0 ]
