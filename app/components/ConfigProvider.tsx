...
export const ConfigProvider = ({ children }: PropsWithChildren) => {
  ...
  const setColorMode = useCallback(
    (value: ColorMode) => {
      ...
      if (body.classList.contains(value === "dark" ? "light" : "dark")) {
        body.classList.remove(value === "dark" ? "light" : "dark");
      }
      body.classList.add(value);

      body.classList.add("has-transition");

      root.style.setProperty(THEME_CSS_PROP, value);
      const newColors = value === "dark" ? DARK_COLORS : LIGHT_COLORS;
